...
class GVinumTest {
	...
	fun listDrives() {
		...
		whenever(execChannel.invertedOut).then {
			resource("com/github/kerubistan/kerub/utils/junix/storagemanager/gvinum/drives.txt")
		}
	...
	fun listSubDisks() {
		...
		whenever(execChannel.invertedErr).then { NullInputStream(0) }
		whenever(execChannel.invertedOut).then {
			resource("com/github/kerubistan/kerub/utils/junix/storagemanager/gvinum/subdisks.txt")
		}
	...
	fun listVolumes() {
		...
		whenever(execChannel.invertedErr).then { NullInputStream(0) }
		whenever(execChannel.invertedOut).then {
			resource("com/github/kerubistan/kerub/utils/junix/storagemanager/gvinum/volumes.txt")
		}
	...
	fun listPlexes() {
		...
		whenever(execChannel.invertedErr).then { NullInputStream(0) }
		whenever(execChannel.invertedOut).then {
			resource("com/github/kerubistan/kerub/utils/junix/storagemanager/gvinum/plexes.txt")
		}
