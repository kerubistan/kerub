...
class BsdDmesgTest {
	...
	fun listCpuFlags() {
		...
		whenever(channelExec.invertedOut).thenReturn(resource("com/github/kerubistan/kerub/utils/junix/dmesg/bsd-dmesg-flags.txt"))
	...
	fun listCpuFlagsWithAmd() {
		...
		whenever(channelExec.invertedErr).thenReturn(NullInputStream(0))
		whenever(channelExec.invertedOut).thenReturn(resource("com/github/kerubistan/kerub/utils/junix/dmesg/bsd-dmesg-freebsd10-amd.txt"))
