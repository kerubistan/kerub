...
fun addSlashPrefix(path: String) = if (path.startsWith(slash)) path else "$slash$path"

fun addSlashPostFix(path: String) = if (path.endsWith(slash)) path else "$path$slash"
